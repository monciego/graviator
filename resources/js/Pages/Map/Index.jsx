        ...
        <>
            ...
            <div className="min-h-screen flex-grow w-full bg-white bg-grid-black/[0.1] flex items-center justify-center relative">
                ...
                <APIProvider apiKey={apiKey}>
                    ...
                    {isOpen && (
                        <div className="fixed z-[1000] top-2/4 left-2/4 transform -translate-x-2/4 -translate-y-2/4 w-full max-w-md border rounded-lg shadow bg-gray-950 border-gray-700">
                            <main className="flex-1 relative z-0 overflow-y-auto focus:outline-none xl:order-last pb-10">
                                <div>
                                    <button
                                        onClick={() => openHandler(data)}
                                        className="absolute top-2 right-2 inline-block text-gray-50 border border-gray-50 bg-red-500 hover:bg-red-600 focus:ring-2 focus:outline-none focus:ring-red-700 rounded-lg text-sm p-1.5"
                                        type="button"
                                    >
                                        <span className="sr-only">
                                            Close Profile
                                                    ...
                                                    <div>
                                                        <ul className="text-sm">
                                                            ...
                                                            <li>
                                                                Date of Birth:{" "}
                                                                {
                                                                    data.deceased_date_of_birth
                                                                }
                                                            </li>
                                                            <li>
                                                                Date of Death:{" "}
                                                                {
                                                                    data.deceased_date_of_death
                                                                }
                                                            </li>
                                                            <li>
                                                                Gender:{" "}
